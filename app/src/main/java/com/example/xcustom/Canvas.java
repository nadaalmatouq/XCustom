...
public class Canvas extends AppCompatActivity {
  ...
  FirebaseDatabase db = FirebaseDatabase.getInstance("https://xcustomdb-default-rtdb.firebaseio.com/");
   ...
   // final TextView dropDesign = findViewById(R.id.textView3);
      @Override
      protected void onCreate(Bundle savedInstanceState) {
          super.onCreate(savedInstanceState);
          setContentView(R.layout.activity_canvas);
    ...
    //  addToCart.setRadius(10);
        ...
        mPickColorButton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        ...
                        new ColorPickerPopup.Builder(Canvas.this).initialColor(
        ...
        final EditText editTextName1 = new EditText(Canvas.this);
...
// titles can be used regardless of a custom layout or not
        ...
        categories.add("25x25cm");
        categories.add("15x21cm");
        categories.add("21x30cm");
        categories.add("30x30cm");
        ...
        addToCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ItemCanvas canvas = new ItemCanvas(String.valueOf(spinner.getSelectedItem()),Integer.toString(mDefaultColor),imageUri.toString(),getInput );
                ...
                dbRef.child("Cart").push().setValue(canvas);

                Intent intent= new Intent(Canvas.this,Checkout.class);
