    ...
    String getInput;
     ...
     protected void onCreate(Bundle savedInstanceState) {
      ...
      //  addToCart.setRadius(10);
        ...
        mPickColorButton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        ...
                        new ColorPickerPopup.Builder(Mug.this).initialColor(
        ...
        final EditText editTextName1 = new EditText(Mug.this);
...
// titles can be used regardless of a custom layout or not
        ...
        addToCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //  Intent intent= new Intent(Hoodies.this,Canvas.class);
                //  intent.putExtra("data",String.valueOf(spinner.getSelectedItem()));
                //  startActivity(intent);
                ItemMug mug = new ItemMug(Integer.toString(mDefaultColor),imageUri.toString(),getInput );
                ...
                dbRef.child("Cart").push().setValue(mug);

                Intent intent= new Intent(Mug.this,Checkout.class);
